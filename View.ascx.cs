    ...
    public partial class View : EmployeeTimeReportModuleBase, IActionable
    {
        ...
        private void GenerateOrDownloadReport(bool download)
        {
            try
            {
                ...
                {
                    whereClause += " AND CAST(LogTime AS TIME) BETWEEN @startTime AND @endTime";
                    parameters.Add(new SqlParameter("@startTime", startTime));
                    parameters.Add(new SqlParameter("@endTime", endTime));
                }
                else if (hasStartTime)
                {
                    whereClause += " AND CAST(LogTime AS TIME) >= @startTime";
                    parameters.Add(new SqlParameter("@startTime", startTime));
                }
                else if (hasEndTime)
                {
                    whereClause += " AND CAST(LogTime AS TIME) <= @endTime";
                    parameters.Add(new SqlParameter("@endTime", endTime));
                }
                ...
                else
                {
                    ...
                    // Scatter plot data with tooltips
